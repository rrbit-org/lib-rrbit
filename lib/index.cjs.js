 ...
 * @property {function(): Vector} VectorApi.nth
 * @property {function(): Vector} VectorApi.update
 * @property {function(): Vector} VectorApi.prepend
 * @property {function(): Vector} VectorApi.append
 * @property {function(): Vector} VectorApi.appendǃ
 * @property {function(): Vector} VectorApi.appendAll
 * @property {function(): Vector} VectorApi.empty
 * @property {function(): Vector} VectorApi.iterator
 * @property {function(): Vector} VectorApi.reverseIterator
 */
...
function setup(factory) {
	...
	'nth drop take update prepend append appendǃ appendAll empty iterator reverseIterator'
		.split(' ')
		.forEach(function (name) { return lib[name] = VectorApi[name].bind(lib); });
